...
const Login = () => {
  ...
  return (
    <LoginDiv>
      ...
      >
        <Form.Item name="title" style={{textAlign:"center", marginBottom:"2rem"}}>
        ...
        >
          <Button type="primary" htmlType="submit" size="large" style={{width:"100%",marginTop:"1.5%",backgroundColor:"#2C73D2"}}>
            Login
          </Button>
        </Form.Item>
      </Form>
